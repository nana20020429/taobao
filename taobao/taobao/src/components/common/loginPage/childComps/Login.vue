...
<script>
import DragVerify from "../../dragVerify/DragVerify"; //滑动验证
//获取用户登录设备
...
export default {
  ...
  methods: {
    ...
    getUser() {
      ...
      if(this.isPassing) this.loginForm.isPassing = "yes"
      this.$api.user
        .login({
          LoginName: this.loginForm.LoginName,
          LoginPassword: this.loginForm.LoginPassword,
          isPassing:this.loginForm.isPassing,
        ...
        .then((res) => {
          ...
          this.$store.dispatch("addUserData", userData).then((cg) => {
            ...
            if (this.isremCheck) {
              let value =
                this.loginForm.LoginName + "," + this.loginForm.LoginPassword;
